...
Ansible project for deploying [Double Take](https://github.com/jakowenko/double-take) via Docker Compose on a single host.

**Target host:** `double-take.local.iamrobertyoung.co.uk`
...
├── roles/
│   └── double-take/            # Custom Double Take role
...
| `double-take` | Custom | Double Take deployment |
